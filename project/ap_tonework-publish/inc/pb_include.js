var include = {
	...
	scripts : function(){
		...
		document.write('<script src="/resources/js/scrollmagic/ScrollMagic.js"></script>');
		document.write('<script src="/resources/js/scrollmagic/plugins/debug.addIndicators.js"></script>');
		document.write('<script src="/resources/js/scrollmagic/plugins/TweenMax.min.js"></script>');
		document.write('<script src="/resources/js/scrollmagic/plugins/animation.gsap.js"></script>');
		document.write('<script src="/resources/js/common.js"></script>');
	},
	styles : function(){
		document.write('<link rel="stylesheet" href="https://use.typekit.net/zjv6udh.css"></link>');
		...
		document.write('<link rel="stylesheet" href="/resources/css/tonework_pc.css">');
		document.write('<link rel="stylesheet" href="/resources/css/tonework_tablet.css">');
		document.write('<link rel="stylesheet" href="/resources/css/tonework_mobile.css">');
	},
	title : function(){
	...
	header : function(){
		...
		document.write('<li><a href="">FIND YOUR COLOR</a></li>');
		document.write('<li><a href="">PRODUCT</a></li>');
		document.write('<li><a href="">EVENT</a></li>');
		document.write('<li><a href="">COMMUNITY</a></li>');
		document.write('</ul>');
		document.write('<div class="gnb_info">');
		document.write('<a href="" class="gnb_info_my">');
	...
	quickBtn : function(){
		...
		document.write('<button type="button" class="quick_btn_top" onclick="go_top();">맨 위로 바로가기</button>');
		document.write('</div>');
	},
	footer : function(){
		...
		document.write('<img src="/resources/images/common/logo_fotter.svg" alt="">');
		document.write('<img class="ico_star" src="/resources/images/icon/icon_34_star@2x.png" alt="">');
		document.write('</div>');
		document.write('<!-- // footer_logo -->');
		...
		document.write('<dl>');
		document.write('<dt>');
		document.write('<a href="#">FIND YOU COLOR</a>');
		document.write('</dt>');
		document.write('<dd>');
		document.write('<ul class="depth">');
		document.write('<li><a href="#">스킨톤파인더</a></li>');
		document.write('<li><a href="#">쉐이드피커</a></li>');
		document.write('</ul>');
		document.write('</dd>');
		document.write('</dl>');
		document.write('</li>');
		...
		document.write('<dd>');
		document.write('<ul class="depth">');
		document.write('<li><a href="#">페이스</a></li>');
		document.write('<li><a href="#">립</a></li>');
		document.write('</ul>');
		document.write('</dd>');
		document.write('</dl>');
		document.write('</li>');
		...
		document.write('<dl>');
		document.write('<dt>');
		document.write('<a href="#">EVENT</a>');
		document.write('</dt>');
		document.write('<dd>');
		document.write('<ul class="depth">');
		document.write('<li><a href="#">이벤트</a></li>');
		document.write('</ul>');
		document.write('</dd>');
		document.write('</dl>');
		document.write('</li>');
		...
		document.write('<li><a href="#">자주묻는 질문</a></li>');
		document.write('<li><a href="#">고객 게시판</a></li>');
		document.write('<li><a href="#">제품 리뷰</a></li>');
		document.write('</ul>');
		document.write('</dd>');
		document.write('</dl>');
		document.write('</li>');
		...
		document.write('<p>고객상담팀(수신자요금부담) 080-023-5454 (상담시간 월~금 : AM 09:00 ~ PM 06:00)</p>');
		document.write('</div>');
		document.write('</div>');
		...
		document.write('<li><a href="#"><strong>개인정보처리방침</strong></a></li>');
		document.write('<li><a href="#">영상정보처리방침</a></li>');
		document.write('<li><a href="#" target="_blank">뷰티포인트</a></li>');
		document.write('</ul>');
		document.write('<p class="copy_right">ⓒ AMOREPACIFIC CORPORATION. All rights reserved.</p>');
		document.write('</div>');
		document.write('</div>');
		document.write('</div>');
	},
